            ...
            <div class="card">
                ...
                <div class="card-body" style="margin-left:50px; margin-right:20px">
                    <form action="{{route('user.store')}}" class="form-inner"
                        ...
                        <div class="form-group row pb-3">
                            <label for="phone" class="col-sm-2 col-form-label">Contact Number<i
                                    class="text-danger">*</i> </label>
                            <label for="" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <input name="designation" type="text" class="form-control" placeholder="Type Designation">
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <input class="mr-3 ml-3" name="position[]" type="checkbox" value="Photographer">  Photographer 
                                <input class="mr-3 ml-3" name="position[]" type="checkbox" value="Cinematographer">  Cinematographer 
                                <input class="mr-3 ml-3" name="position[]" type="checkbox" value="Photo Editor">  Photo Editor 
                                <input class="mr-3 ml-3" name="position[]" type="checkbox" value="Cine Editor">  Cine Editor
                            </div>
                        </div>
                        <div class="form-group row pb-3">
