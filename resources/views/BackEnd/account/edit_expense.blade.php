...
<div class="content-header row align-items-center m-0" id="bedcumb">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <h4 class="card-header">Edit Expense</h4>
                <div class="card-body" style="margin-left:50px; margin-right:20px">
                    <form action="{{route('expense.update',$expense->id)}}" class="form-inner"
                           ...
                           <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="expense_type" id="" class="form-control form-select chosen-select">
                                    ...
                                    <option value="Fixed" @if($expense->expense_type == 'Fixed') selected @endif >Fixed</option>
                                    <option value="Office Expense" @if($expense->expense_type == 'Office Expense') selected @endif>Office Expense</option>
                                    <option value="Variable" @if($expense->expense_type == 'Variable') selected @endif>Variable</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <input name="remarks" type="text" class="form-control" id="remarks"
                                    placeholder="Type a note Here...." value="{{$expense->remarks}}">
                            </div>
                        </div>                    
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <input name="amount" type="number" class="form-control" id="amount"
                                    placeholder="Type Amount.." value="{{$expense->amount}}">
                            </div>
                        </div>                    
                        <div class="form-group row pb-3">
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="payment_type" id="payment" class="form-control form-select" onchange="paymentType();">
                                    ...
                                    <option value="bKash" @if($expense->payment_type == 'bKash') selected @endif>bkash</option>
                            ...
                            <div class="form-group row pb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="old_transaction_id" id="transaction_id" class="form-control"
                                        placeholder="Type bKash Transaction ID" value="{{$expense->transaction_id}}">
                                </div>
                            </div>
                        @else
                            ...
                            <div class="form-group row pb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="old_account_no" id="account_no" class="form-control"
                                        placeholder="Type Bank Account No.." value="{{$expense->account_no}}">
                                </div>
                            </div>
                        @else
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <input name="document" type="file" class="form-control" id="document"
                                    placeholder="" >
                                <small class="text-success">Previous Document:{{ $expense->document ? $expense->document :'' }}</small>
                            </div>
                        </div>
