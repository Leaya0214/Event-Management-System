        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body" style="margin-left:50px; margin-right:20px">
                    <form action="{{route('income.store')}}" class="form-inner"
                        ...
                        <div class="form-group row pb-3">
                            <label for="name" class="col-sm-2 col-form-label">Select Income Category </label>
                        ...
                        <div class="form-group row pb-3">
                            <label for="name" class="col-sm-2 col-form-label">Income Amount<i
                                    class="text-danger">*</i> </label>
                            <label for="" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row pb-3">
                            <label for="name" class="col-sm-2 col-form-label">Income Date<i
                                    class="text-danger">*</i> </label>
                            <label for="" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row pb-3" id="bank">
                            <label for="name" class="col-sm-2 col-form-label">Status<i
                                class="text-danger">*</i></label>
                            <label for="" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row pb-3">
                            <label for="name" class="col-sm-2 col-form-label">Attachment (If any)</label>
                            <label for="" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-9">
