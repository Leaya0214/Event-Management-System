    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="row  pr-3">
                    <div class="col-md-6">
                        <h6 class="card-title">Event Shift table</h6>
                        <p class="text-muted mb-3">Manage Shifts</p>
                    </div>
                    <div class="col-md-6 text-end">
                        @can('shift.create')
                        <button type="button" class="btn btn-primary w-md" data-bs-toggle="modal"
                            data-bs-target="#exampleModal">
                            <h6><i class="fas fa-plus"></i> Add Shift</h6>
                        </button>
                        @endcan
                    </div>
                </div>
                            ...
                            @foreach ($shifts as $shift)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if ($shift->status == 1)
                                        <a href="{{ route('shift.status', $shift->shift_id) }}" style="padding:2px 4px 2px 0;" 
                                    ...
                                    <td>
                                        @can('shift.edit')
                                        <a href="" data-toggle="modal" data-target=".edit-{{ $shift->shift_id }}"
                                        ...
                                        @endcan
                                        @can('shift.delete')
                                        <a href="{{ route('shift.delete', $shift->shift_id) }}"
                                ...
                                <div class="modal fade bg-dark edit-{{ $shift->shift_id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('shift.update', $shift->shift_id) }}" method="POST"
                                                class="form-horizontal" enctype="multipart/form-shift">
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="form-group row pt-3">
                                                        <label for="shift_name" class="col-sm-3 col-form-label">Shift Name</label>
                                                        <label for="" class="col-sm-1 col-form-label">:</label>
                                                        <div class="col-sm-8">
                                                            <input name="shift_name" id="shift_name" type="text" class="form-control" value="{{$shift->shift_name}}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row pt-3">
                                                        ...
                                                        <label for="" class="col-sm-1 col-form-label">:</label>
                                                        <div class="col-sm-8">
                                                            <input name="start_time" id="start_time" type="time" class="form-control" value="{{$shift->start_time}}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row pt-3">
                                                        ...
                                                        <label for="" class="col-sm-1 col-form-label">:</label>
                                                        <div class="col-sm-8">
                                                            <input name="end_time" id="end_time" type="time" class="form-control" value="{{$shift->end_time}}">
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('shift.store') }}" method="POST" enctype="multipart/form-shift">
                    @csrf
                    ...
                    <div class="modal-body"> 
                        <div class="form-group row pt-3">
                            ...
                            <label for="" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-8">
                                <input name="shift_name" id="shift_name" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row pt-3">
                            <label for="start_time" class="col-sm-3 col-form-label">Start Time</label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" shift-bs-dismiss="modal">Close</button>
