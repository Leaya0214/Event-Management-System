...
<div class="content-header row m-0" id="bedcumb">
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body" style="margin-left:50px; margin-right:20px">
                    <form action="{{route('client_review.update',$client_review->id)}}" class="form-inner"
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <input name="name" type="text" class="form-control" id="name"
                                    placeholder="Type Client Name" value="{{$client_review->client_name}}" >
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                               <input type="text" class="form-control" name="rating" placeholder="Give Rating Here.." value="{{$client_review->rating}}">
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <img src="{{asset('backend/client_review/'.$client_review->bg_image)}}" alt="" height="100" width="100">
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea name="comment" class="form-control "  cols="10" rows="5">{!! $client_review->comment !!}</textarea>
                            </div>
                        </div>
