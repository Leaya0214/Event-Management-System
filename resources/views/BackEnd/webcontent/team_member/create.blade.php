        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body" style="margin-left:50px; margin-right:20px">
                    <form action="{{route('member.store')}}" class="form-inner"
                        ...
                        <div class="form-group row pb-3">
                            <label for="details" class="col-sm-2 col-form-label">Short Details<i
                                class="text-danger">*</i></label>
                            <label for="address" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-9">
                               <input type="text" name="details" id="" class="form-control" placeholder="Type...">
                            </div>
                        </div>
                        <div class="form-group row pb-3">
