            ...
            <div class="card-body">
                <div class="row  pr-3">
                    <div class="col-md-6">
                        ...
                        <p class="text-muted mb-3">Manage Services</p>
                    </div>
                    <div class="col-md-6 text-end">
                        @can('service.create')
                        <a href="{{ route('service.add') }}" class="btn btn-md btn-primary">
                        ...
                        <tbody>
                            ...
                            @foreach ($services as $service)
                                <tr>
                                    ...
                                    <td>{{ $service->title }}</td>
                                    <td>
                                        <a href="" service-toggle="modal"
                                            service-target=".image-modal-{{ $service->id }}">
                                                @php
                                                    $extension = pathinfo($service->image_video, PATHINFO_EXTENSION);
                                                @endphp
                                                 @if($extension == 'jpg')
                                    ...
                                    <td>
                                        @can('service.edit')
                                        @if ($service->status == 1)
                                            <a href="{{ route('service.status', $service->id) }}" style="padding:2px;"
                                        ...
                                        @else
                                            <a href="{{ route('service.status',$service->id) }}"
                                        ...
                                        <a href=""  data-bs-toggle="modal" 
                                            data-bs-target=".image_modal-{{ $service->id }}" style="padding:2px; color:white"
                                        ...
                                        @endcan
                                        @can('service.edit')
                                        <a href="{{ route('service.edit',$service->id) }}" style="padding:2px;"
                                ...
                                {{-- View Modal --}}
                                <div class="modal fade bg-dark image_modal-{{ $service->id }}" id=""
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        @endphp
                                                        @if($extension == 'jpg')
                                                         <img src="{{ asset('backend/service/' . $service->image_video) }}" alt=""  width="200" height="240">
                                                        @else
