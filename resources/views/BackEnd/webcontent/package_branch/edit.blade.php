...
<div class="content-header row align-items-center m-0" id="bedcumb">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <h4 class="card-header">Update Package Branch</h4>
                <div class="card-body" style="margin-left:50px; margin-right:20px">
                    <form action="{{route('package_branch.update',$branch_edit->id)}}" class="form-inner"
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <input name="branch_name" value="{{$branch_edit->branch_name}}" type="text" class="form-control" 
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <label for="" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-9">
                                <input name="address" value="{{$branch_edit->address}}" type="text" class="form-control"
