...
<div class="content-header row align-items-center m-0" id="bedcumb">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <h4 class="card-header">Update Service</h4>
                <div class="card-body" style="margin-left:50px; margin-right:20px">
                    <form action="{{route('blog.update',$blog->id)}}" class="form-inner"
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <input name="title" type="text" class="form-control" id="title"
                                    placeholder="Type Blog Title..." value="{{$blog->title}}" >
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <img src="{{asset('backend/blog/'.$blog->image)}}" alt="" width="100px" height="100px">
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <img src="{{asset('backend/blog_gallery/'.$image->image)}}" alt="" height="60px" width="60px">
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea name="description" class="form-control textarea" id="summernote" cols="30" rows="10">{!! $blog->description !!}</textarea>
                            </div>
                        </div>
