        ...
        <div class="card-body">
            <div class="row  pr-3">
                <div class="col-md-6">
                    ...
                    <p class="text-muted mb-3">Manage Blogs</p>
                </div>
                @can('blog.create')
                <div class="col-md-6 text-end">
                    <a href="{{route('blog.add')}}" class="btn btn-md btn-primary">
            ...
            <div class="table-responsive pt-3">
                ...
                style="width:100%; text-align:center;" data-table="true" id="blogTable">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Blog Title</th>
