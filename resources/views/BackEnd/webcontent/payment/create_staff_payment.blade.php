        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body" style="margin-left:50px; margin-right:20px;">
                    <form action="{{route('staff.payment.store')}}" class="form-inner"
                        ...
                        <input type="hidden" name="user_id" value="{{$id}}">
                            <div class="form-group row pb-3">
                                <label for="date" class="col-sm-2 col-form-label"> Total Due </label>
                            ...
                            <div class="form-group row pb-3">
                                <label for="amount" class="col-sm-2 col-form-label"> Partial Payment <i
                            ...
                            <div class="form-group row pb-3">
                                <label for="trans_id" class="col-sm-2 col-form-label">Transaction Id/ Acc. No. </label>
                                <label for="" class="col-sm-1 col-form-label">:</label>
                                <div class="col-sm-9">
