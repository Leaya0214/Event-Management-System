...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <div class="row  pr-3">
                <div class="col-md-6">
                    <h6 class="card-title">Package Type</h6>
                    <p class="text-muted mb-3">Manage All Package Types</p>
                </div>
                <div class="col-md-6 text-end">
                    <a href="{{route('package_type.add')}}" class="btn btn-md btn-primary">
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($type->status == 1)
                                        <a href="{{ route('package_type.status', $type->id) }}" style="padding:2px;"
                                    ...
                                    @else
                                        <a href="{{ route('package_type.status',$type->id) }}"
                                    ...
                                    @endif
                                    <a href="{{ route('package_type.edit',$type->id) }}" style="padding:2px;"
                                    ...
                                    <a href="{{ route('package_type.delete',$type->id) }}"
