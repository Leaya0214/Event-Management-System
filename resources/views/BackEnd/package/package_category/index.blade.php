        ...
        <div class="card-body">
            <div class="row  pr-3">
                <div class="col-md-6">
                    ...
                    <p class="text-muted mb-3">Manage All Package Categories</p>
                </div>
                <div class="col-md-6 text-end">
                    <a href="{{route('package_category.add')}}" class="btn btn-md btn-primary">
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($category->status == 1)
                                        <a href="{{ route('package_category.status', $category->id) }}" style="padding:2px;"
                                    ...
                                    @else
                                        <a href="{{ route('package_category.status',$category->id) }}"
                                    ...
                                    @endif
                                    <a href="{{ route('package_category.edit',$category->id) }}" style="padding:2px;"
                                    ...
                                    <a href="{{ route('package_category.delete',$category->id) }}"
