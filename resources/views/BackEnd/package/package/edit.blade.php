...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <h4 class="card-header">Update Package</h4>
                <div class="card-body" style="margin-left:50px; margin-right:20px">
                    <form action="{{ route('package.update',$package_edit->id) }}" enctype="multipart/form-data"
                        ...
                        <div class="form-group row pb-3">
                            <label class="col-sm-2 form-label" for="">Package Branch<span
                            ...
                            <div class="col-sm-9">
                                <select class="form-control chosen" name="package_branch_id" id="">
                                    ...
                                    @foreach ($branches as $branch)
                                        <option value="{{ $branch->id }}" {{ $branch->id ==  $package_edit->package_branch_id  ? 'selected' : '' }}>{{ $branch->branch_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-9">
                                <select class="form-control chosen" name="package_type_id" id="">
                                    ...
                                    @foreach ($types as $type)
                                        <option value="{{ $type->id }}" {{ $type->id ==  $package_edit->package_type_id  ? 'selected' : '' }}>{{ $type->package_type_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-9">
                                <select class="form-control chosen" name="package_category_id" id="">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" {{ $category->id ==  $package_edit->package_category_id  ? 'selected' : '' }}>{{ $category->category_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row pb-3">
                            <label for="name" class="col-sm-2 col-form-label">Edit Title<i class="text-danger">*</i>
                            </label>
                            <label for="" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-9">
                                <input name="name" type="text" class="form-control"
                                    placeholder="Package Title" value="{{$package_edit->name}}">
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                            <label for="position" class="col-sm-2 col-form-label">Edit Position<i class="text-danger">*</i>
                            </label>
                            <label for="" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-9">
                                <input name="position" type="number" class="form-control"
                                    placeholder="Package Position" value="{{$package_edit->position}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <input name="short_title" type="text" class="form-control"
                                    placeholder="Type Here.."  value="{{$package_edit->short_title}}" >
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <label for="" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-9">
                                <input name="amount" type="number" value="{{$package_edit->amount}}" class="form-control"
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <input name="discount" type="number" class="form-control"
                                    placeholder="Current Amount " value="{{$package_edit->discount}}" >
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea name="short_details" type="text" class="form-control "
                                    placeholder="Package short Details">{{$package_edit->short_details}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                            <label for="long_details" class="col-sm-2 col-form-label">Edit Details<i class="text-danger">*</i>
                            </label>
                            <label for="" class="col-sm-1 col-form-label">:</label>
                            <div class="col-sm-9">
                                <textarea name="long_details" type="text" class="form-control textarea"
                                    placeholder="Package Details">{!! $package_edit->long_details !!}</textarea>
                            </div>
                        </div>
